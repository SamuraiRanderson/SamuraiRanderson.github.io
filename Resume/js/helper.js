...
var HTMLmobile = '<li class="flex-item"><i class="fa fa-mobile-phone fa-2x"></i><span class="contact-text">%data%</span></li>';
var HTMLemail = '<li class="flex-item"><i class="fa fa-envelope fa-2x"><span class="contact-text">%data%</span></li>';
//var HTMLtwitter = '<li class="flex-item"><span class="orange-text">twitter</span><span class="white-text">%data%</span></li>';
var HTMLgithub = '<li class="flex-item"><i class="fa fa-github-alt fa-2x"><span class="contact-text">%data%</span></li>';
//var HTMLblog = '<li class="flex-item"><span class="orange-text">blog</span><span class="white-text">%data%</span></li>';
var HTMLlocation = '<li class="flex-item"><i class="fa fa-map-marker fa-2x"><span class="contact-text">%data%</span></li>';
var HTMLlinkedIn = '<li class="flex-item"><i class="fa fa-linkedin-square fa-2x"></i><span class="contact-text">%data%</span></li>';
